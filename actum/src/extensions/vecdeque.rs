    ...
    T: Clone + Send + Sync + 'static,
{
    ...
    /// # #[tokio::main]
    /// # async fn main() {
    /// let mut handle = VecDequeHandle::new(VecDeque::<i32>::new());
    ...
    /// # #[tokio::main]
    /// # async fn main() {
    /// let mut handle = VecDequeHandle::new(VecDeque::from([10, 20, 30]));
...
where
    T: Clone + Send + Sync + 'static,
    S: actum::Sink<VecDequeCall<T>> + Unpin + Clone,
{
